...
module.exports = {
  homeSidebarB:
    ...
    <p style="
      ...
      margin: 0 0 8px 0;
    ">Telegram电报群</p>
    <img src="https://singerwimg-1300001977.cos.ap-beijing.myqcloud.com/2021/06/06/d086057358361.png"  style="width:100%;" />
    <p>
      <span>本站文章采用<a href="https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1" target="_blank">知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议进行许可</a>，欢迎任何形式的转载，但请务必注明出处。</span>
    </p>
    </div>`,
  // `<!-- 纵向自适应 -->
